# UniTask
[UniTask](https://github.com/Cysharp/UniTask)をフォークし、アナライザの CancellationToken 渡し漏れをエラーから警告にさげただけのものです。

## ビルド方法
以下コマンドを実行することでビルドできます。

````
nuget restore UniTask.NetCore.sln
msbuild /p:Configuration=Release UniTask.NetCore.sln
````
